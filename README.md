...
FCentric is a fashion omnichannel retail and warehouse management system.

The software is developed under the project:

**Phát triển Hệ thống Quản lý kho hàng và Bán lẻ thời trang đa kênh**

### Main Features

- Manage fashion products, inventory, sizes, colors, collections, and SKUs.
